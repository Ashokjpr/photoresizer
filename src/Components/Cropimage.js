...
function Cropimage() {
    document.title = "PhotoEdit - Crop Image Online Free";
  ...
  const getCroppedImg = () => {
    ...
    return (
        <div className="container py-5 ">
            ...
            <h5 className="text-center fst-italic">Crop <b>JPG PNG</b> or <b>GIF</b> by defining a rectangle in pixels. <br/>Cut your image online.</h5>
