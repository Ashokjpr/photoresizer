  ...
  return (
    <div className='container py-5'>
      <div className="home-title container text-center">
        <h1 className="home-title__title fw-bold">Every tool you could want to edit images in bulk</h1>
        <h4 className="home-title__subtitle fst-italic">Your online photo editor is here and forever free!</h4>
    </div>
    <div className='container d-flex justify-content-center  py-5'>
      <div className="container rounded p-4 shadow-lg  hover-border" style={{ width: "16rem" }}>
